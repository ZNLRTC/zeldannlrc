<body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
        ...
        <div class="wrapper">
            <!-- ========== Left Sidebar Start ========== -->
            <?php include 'leftSideMenu_html.php'?>
                ...
                <?php include 'topbar_html.php'?>
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="<?php echo BASE_URL; ?>profile/filemanager">File Manager</a></li>
                        ...
                        <div class="row">
                            ...
                            <!-- Right Sidebar -->
                            <div class="col-12">
                                <p class="label">Note: Please rename the file before uploading.</p>
                                <div class="card">
                                    <div class="card-body">
